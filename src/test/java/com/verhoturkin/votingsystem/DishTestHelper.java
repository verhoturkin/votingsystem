...
public class DishTestHelper {
    ...
    public static final DishDto DISH1 = new DishDto(DISH1_ID, "Биг Мак", LocalDate.now(), 13501);
    public static final DishDto DISH2 = new DishDto(100007, "Чикен Премьер", LocalDate.now(), 13990);
    public static final DishDto DISH3 = new DishDto(100008, "Биг Тейсти", LocalDate.of(2015, 05, 31), 24980);

    public static final DishDto DISH4 = new DishDto(100009, "Биг Кинг", LocalDate.now(), 15010);
    public static final DishDto DISH5 = new DishDto(100010, "Воппер", LocalDate.now(), 19630);
    public static final DishDto DISH6 = new DishDto(100011, "Беконайзер", LocalDate.of(2015, 05,31), 33058);

    public static final DishDto DISH7 = new DishDto(100012, "БоксМастер", LocalDate.now(), 19425);
    public static final DishDto DISH8 = new DishDto(100013, "Крылья острые", LocalDate.now(), 10930);
