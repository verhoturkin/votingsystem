...
VALUES (now(), 'Биг Мак', 13501, 100003),
       (now(), 'Чикен Премьер', 13990, 100003),
       ('2015-05-31', 'Биг Тейсти', 24980,100003),
       (now(), 'Биг Кинг', 15010, 100005),
       (now(), 'Воппер', 19630, 100005),
       ('2015-05-31', 'Беконайзер', 33058,100005),
       (now(), 'БоксМастер', 19425, 100004),
       (now(), 'Крылья острые', 10930, 100004),
